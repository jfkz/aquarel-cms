...
<div id="header">
	<div id="logo">
		<h1><a href="/"><span>{$site.name}</span></a></h1>
		<p>{$site.slogan}</p>
	</div>
	<div id="splash"><img src="{$site.theme_path}/images/img02.gif" alt="" />&nbsp;</div>
	<div id="menu">
	...
	<div id="page">
		<div id="sidebar1" class="sidebar">
			<ul>
				<li>
					...
					<p class="tag">Текст внутри блока.</p>
				</li>
				<li>
		...
		<div id="content">
			...
			<div class="post">
				...
				<p class="byline"><small>about</small></p>
				<div class="entry">
					{$page.text}
				</div>
			</div>
...
<div id="footer">
	<p class="copyright">Copyright (c) 2010 {$site.name}. All rights reserved. Design by <a href="http://www.freecsstemplates.org/">Free CSS Templates</a>.</p>
</div>
</body>
</html>
