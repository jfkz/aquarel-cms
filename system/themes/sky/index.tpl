...
<head>
    ...
    <!--[if IE7]>
    <style type="text/css"> BODY { behavior:url("{$site.theme_path}/js/csshover.htc"); } </style>
    <![endif]-->
    
    <link rel="stylesheet" type="text/css" href="/system/lib/jQuery/jquery-ui/css/redmond/jquery-ui-1.8.16.custom.css" />
    <link rel="stylesheet" type="text/css" href="{$site.theme_path}/css/main.css" />
    
    {$js_vars}
    <script type="text/javascript" language="javascript">
        var acTpl='{$site.theme_path}/';
    </script>
    
    <script type="text/javascript" src="/system/lib/jQuery/jquery.js"></script>
    <script type="text/javascript" src="/system/lib/jQuery/jquery-ui/js/jquery-ui.js"></script>
    ...
    <script type="text/javascript" src="{$site.theme_path}/js/json.js"></script>
...
<body>
    ...
    <div class="header">
        <div class="logo">
            <a href="/control"><img src="{$site.theme_path}/images/logo.png" alt="" /></a>
                <div class="site_name">
                    <div class="l"><div class="r"><div class="f"><a href="/" target="_blank">{$site.name}</a></div></div></div>
                </div>
